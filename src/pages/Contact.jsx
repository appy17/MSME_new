              ...
              <div class="contact-detail">
                <ul class="contact-ul">
                  <li className="add">
                    ...
                    <h4>
                      CGO Complex, Block "C", Ground Floor, Seminary Hills, Nagpur, Maharashtra 440006
                    </h4>
                  </li>
                  ...
                  <li className="add">
                    ...
                    <a href="tel:0-7122-5103-52">
                      <h4> 0-7122-5103-52</h4>
                    </a>
                  </li>
                  <li className="add">
                    <FaPhone className="ic" />
                    <a href="tel:0-7122-5100-46">
                      <h4> 0-7122-5100-46</h4>
                    </a>
                  </li>
                  ...
                  <li className="add">
                    ...
                    <a href="mailto:pardeepkumar4bjp@gmail.com">
                      <h4> dcdi-nagpur@dcmsme.gov.in</h4>
                    </a>
                  </li>
                  <li className="add">
